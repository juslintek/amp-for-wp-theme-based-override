	...
	<div class="ampforwp-social-icons">
		<?php if( true == $redux_builder_amp['ampforwp-facebook-like-button'] ) {
			...
			if( $facebook_like_url ){ ?>
				<amp-facebook-like width=<?php echo $like_icon_width ?> height=28
				 	layout="fixed"
				 	data-size="large"
		...
		<?php if($redux_builder_amp['enable-single-facebook-share'] == true)  { ?>
			<amp-social-share type="facebook"    data-param-app_id="<?php echo $redux_builder_amp['amp-facebook-app-id']; ?>" width="<?php echo $icon_width ?>" height="<?php echo $icon_height ?>"></amp-social-share>
		<?php } ?>
		<?php if($redux_builder_amp['enable-single-twitter-share'] == true)  {
	    $data_param_data = $redux_builder_amp['enable-single-twitter-share-handle'];?>
			<amp-social-share type="twitter"
				width="<?php echo $icon_width ?>"
				height="<?php echo $icon_height ?>"
				data-param-url=""
		...
		<?php if($redux_builder_amp['enable-single-gplus-share'] == true)  { ?>
			<amp-social-share type="gplus"      width="<?php echo $icon_width ?>" height="<?php echo $icon_height ?>"></amp-social-share>
		<?php } ?>
		<?php if($redux_builder_amp['enable-single-email-share'] == true)  { ?>
			<amp-social-share type="email"      width="<?php echo $icon_width ?>" height="<?php echo $icon_height ?>"></amp-social-share>
		<?php } ?>
		<?php if($redux_builder_amp['enable-single-pinterest-share'] == true)  { ?>
			<amp-social-share type="pinterest"  width="<?php echo $icon_width ?>" height="<?php echo $icon_height ?>"></amp-social-share>
		<?php } ?>
		<?php if($redux_builder_amp['enable-single-linkedin-share'] == true)  { ?>
			<amp-social-share type="linkedin" width="<?php echo $icon_width ?>" height="<?php echo $icon_height ?>"></amp-social-share>
		<?php } ?>
